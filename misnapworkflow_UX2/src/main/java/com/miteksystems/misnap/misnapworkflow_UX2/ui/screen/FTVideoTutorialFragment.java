...
public class FTVideoTutorialFragment extends Fragment implements CompoundButton.OnCheckedChangeListener {
     ...
     */
    public static FTVideoTutorialFragment newInstance(@NonNull DocType docChecker, int requestedOrientation) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mDocType.isIdDocument() || mDocType.isBarcode()) {
            rootView = inflater.inflate(R.layout.misnap_video_first_time_tutorial_ids_ux2, container, false);
            TextView message = (TextView) rootView.findViewById(R.id.misnap_video_ft_message_ux2);
            message.setText(Html.fromHtml(getString(R.string.misnap_video_ft_message_ux2)));
            mTutorialImage = (ImageView) rootView.findViewById(R.id.misnap_tutorial_image_ux2);
            loadTutorialImage();
        } else {
            rootView = inflater.inflate(R.layout.misnap_video_first_time_tutorial_non_id_ux2, container, false);
            ...
            TextView message3 = (TextView) rootView.findViewById(R.id.misnap_video_ft_message_3);

            message2.setText(getString(R.string.misnap_video_tutorial_message_2_ux2));
            if (mDocType.isCheck()) {
                message1.setText(getString(R.string.misnap_video_tutorial_message_1_check_ux2));
                message3.setText(getString(R.string.misnap_video_tutorial_message_3_check_ux2));
            } else {
                message1.setText(getString(R.string.misnap_video_tutorial_message_1_document_ux2));
                message3.setText(getString(R.string.misnap_video_tutorial_message_3_document_ux2));
            }
        }
    ...
    public void onResume() {
        ...
        if (mDocType.isCheck()) {
            stringBuilder.append(getString(R.string.misnap_video_tutorial_message_1_check_ux2));
            stringBuilder.append(getString(R.string.misnap_video_tutorial_message_2_ux2));
            stringBuilder.append(getString(R.string.misnap_video_tutorial_message_3_check_ux2));
        } else if(mDocType.isIdDocument() || mDocType.isBarcode()) {
            stringBuilder.append(Html.fromHtml(getString(R.string.misnap_video_ft_message_ux2)));
        } else {
            stringBuilder.append(getString(R.string.misnap_video_tutorial_message_1_document_ux2));
            stringBuilder.append(getString(R.string.misnap_video_tutorial_message_2_ux2));
            stringBuilder.append(getString(R.string.misnap_video_tutorial_message_3_document_ux2));
        }
